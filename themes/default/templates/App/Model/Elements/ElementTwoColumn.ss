<div class="element-two-column<% if $ShowBall && $BallColour != 'None' %> element-two-column--padding-bottom ball--{$BallColour.Lowercase}<% end_if %> element-two-column--{$BackgroundColour}">
