...
use App\Model\Elements\ElementCardFeatureBoxes;
 ...
 */
class CardFeatureBox extends DataObject
{
    use LinkSetTrait;

    private static string $table_name = 'ElementCardFeatureBoxes_CardFeatureBox';
    ...
    private static array $has_one = [
        'FeatureBoxBlock' => ElementCardFeatureBoxes::class,
        'Image'           => Image::class,
                ...
                $fields->addFieldsToTab(
                    ...
                    [
                        ...
                        HTMLEditorField::create('Content', 'Content')
                            ->setEditorConfig(TinyMCEConfig::get('simple')),
